<template>
  <div class="py-4 d-flex flex-column justify-content-center w-100 m-auto ">
    <div class="row ">
      <div class="col-12 text-center">
        <div class='marquees bg-dark'>
...
$from: translateX(calc((-1 * var(--marquee--double-size)) - (var(--marquee--double-size) * var(--marquee--direction, 1))));
$reduce-from: translateX(calc(var(--marquee--repeat-size) * var(--marquee--direction, 1)));
